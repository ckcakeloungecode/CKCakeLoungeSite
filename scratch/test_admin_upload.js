...
async function run() {
  console.log("Testing upload to cake_photos bucket using Admin (Service Role) client...");
  const dummyBuffer = Buffer.from("hello world admin");
  ...
  if (error) {
    ...
    console.log("✅ Admin upload succeeded!", data);
    // clean up
